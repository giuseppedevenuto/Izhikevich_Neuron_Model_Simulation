function [Vout, Vout2Plot, SpikesCount, IstimOut] = Izhikevich_RS(dt, E_rest, Vspike, Istim_in,t,non,noff,Ntrials)
% Function for implementing the RS neuron with Izhikevich equations
% © De Venuto Giuseppe, Impollonia Roberta 2023

% Izhikevich parameters for Regular Spiking
a=0.02;
b=0.2;
c=-65;                                                              % after-spike reset value of the mem. pot. V [mV]
d=8;                                                                % after-spike reset value of the recovery variable U
